...
| 4. 包实现上下文 | [`docs/40-implementation/packages/services/model-platform.md`](../../../docs/40-implementation/packages/services/40-model-platform.md) |

> 职责：AI 模型注册、路由调度、配额计量，端口 3100

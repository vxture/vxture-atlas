...
| [#164](https://github.com/vxture/vxture-platform/issues/164) | platform | Governance gap: no sanctioned path for recurring DB maintenance (TD-018) | Closed - `db-maintenance.yml` third category added (platform#173); migrating `reqlog`'s functions onto it is atlas's own non-urgent scheduling item |
